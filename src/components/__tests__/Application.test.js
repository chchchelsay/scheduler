...
////////////RESPONDS TO DAY CHANGE////////////
  ...
  it("defaults to Monday and changes the schedule when a new day is selected", async() => {
    ...
    .then(() => {
      ...
      expect(
        getByText("Leopold Silvers")).toBeInTheDocument();
    });
  });
...
//////////////////ERROR:SAVE////////////////////////////////////
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, "ERROR: Appointment not saved."));
...
//////////////////ERROR:DELETE////////////////////////////////////
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, "ERROR: Appointment not deleted."));
